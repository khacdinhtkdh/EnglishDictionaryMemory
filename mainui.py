...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.lb_pro = QtWidgets.QLabel(self.tab_2)
        self.lb_pro.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lb_pro.setObjectName("lb_pro")
        self.verticalLayout_3.addWidget(self.lb_pro)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.lb_pro.setText(_translate("mainWindow", "TextLabel"))
